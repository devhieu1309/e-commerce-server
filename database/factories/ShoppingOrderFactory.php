...
class ShoppingOrderFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $customerAddress = CustomerAddress::where('user_id', $user->user_id)->inRandomOrder()->first();

        if (!$customerAddress) {
            $customerAddress = CustomerAddress::inRandomOrder()->first();
        }
        ...
        return [
            ...
            'customer_address_id' => $customerAddress->customer_address_id,

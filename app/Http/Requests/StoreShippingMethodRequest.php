...
class StoreShippingMethodRequest extends FormRequest
{
    ...
    {
        return [
            'shipping_method_name' => 'string|required|max:100|unique:shipping_methods,shipping_method_name',
    ...
    public function messages(): array
    {
        return [
            ...
            'shipping_method_price.min' => 'Giá phương thức vận chuyển không được vượt nhỏ hơn 0.',
        ];
    }
}

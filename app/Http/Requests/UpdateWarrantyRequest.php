    ...
    public function rules(): array
    {
        return [
            'serial_number'   => [
                ...
                'string',
                'max:100',
                Rule::unique('warranty', 'serial_number')->ignore($this->route('warranty'), 'id'),
            ], // chỉ validate nếu có gửi
            ...
            'product_id'      => 'required|exists:products,product_id', // chỉ validate nếu có gửi
        ];
    }
